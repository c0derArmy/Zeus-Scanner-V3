...
def parse_hosts(filepath="/etc/hosts"):
    ...
    try:
        ...
        lib.core.settings.logger.warning(lib.core.settings.set_color(
            "could not modify /etc/hosts (permission denied), continuing anyway...", level=30
        ))
...
def config_gecko_version(browser_version):
    ...
    """
    version_specs = {
        # Modern Firefox versions (60+) - using latest stable geckodriver
        tuple(range(60, 200)): 34,  # Support for Firefox 60-199 with geckodriver v0.34.0
        (59, 58, 57): 19,
        (56, 55, 54): 18,
        (53, 52): 17
    }
